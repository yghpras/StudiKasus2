...
public class PekerjaanFrame extends JFrame {
    ...
    public PekerjaanFrame(PekerjaanDao pekerjaanDao) {
        ...
        JLabel label = new JLabel("Keterangan!: Halaman ini untuk menambah kategori pekerjaan dalam apk biodata");
        label.setBounds(60,5,500,30);

        JLabel labelInput = new JLabel("Nama Pekerjaan :");
